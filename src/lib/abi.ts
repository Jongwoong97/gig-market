/**
 * ABIs generated from compiled Solidity contracts.
 * Source: contracts/artifacts/
 */

export const GIG_MARKETPLACE_ABI = [
  {
    inputs: [],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "enum GigMarketplace.JobStatus", name: "status", type: "uint8" },
          { internalType: "string", name: "evidenceCid", type: "string" },
        ],
        internalType: "struct GigMarketplace.Job",
        name: "",
        type: "tuple",
      },
    ],
